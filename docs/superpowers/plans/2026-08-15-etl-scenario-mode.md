...
Expected: `template_etl.py` and `template_etl_ref.md` both referenced in step 4; the three axes present in step 2; the blacklist present; the row caps present. Confirm `templates/template_v2.py` no longer appears in this file.
